...
class Lex extends Service {
    ...
    public function __construct($ctrl) {
        ...
        $this->db = new PDO("mysql:host=DBHOST;dbname=DBNAME; port=3306", 'DBUSER', 'DBPASS');
